...
class Scheduler extends React.Component {
    ...
    weekDays_html = () =>
        this.state.week_days.map(day => (
            <div key={day.toString()} data-key={day.toString()}>
                <div className={this.props.classes.roots}>
                    <Paper className={this.props.classes.paperIndividual}>
                        <Grid container spacing={40} align="center">
                            <Grid
                                className={this.props.classes.gridsTitle}
                                item
                                xs={12}
                            >
                            ...
                            <Grid
                                className={this.props.classes.grids}
                                item
                                xs={6}
                            >
                                <div>
                                    ...
                                    <DateTimePicker
                                        step={60}
                                        date={false}
                                        onChange={this.handleWeeklyStart(
                                            day.toString()
                                        )}
                            ...
                            >
                                <div>
                                    ...
                                    <DateTimePicker
                                        date={false}
                                        step={60}
                                        onChange={this.handleWeeklyEnd(
                                            day.toString()
                                        )}
                                        min={Moment()
                                            .hour(
                                                this.state.weekly[day]
                                                    .start_time + 1
                                            )
                                            .startOf("hour")
                                            .toDate()}
    ...
    componentDidMount() {
        const token = localStorage.getItem("token");
        axios.get("/api/availability/" + token).then(response => {
                        ...
                        >
                            ...
                            >
                                <div className={this.props.classes.roots}>
                                    <Paper
                                        className={
                                            this.props.classes.paperIndividual
                                        }
                                    >
                                        <Grid
                                            container
...
const SchedulerWrapped = withStyles(styles, { withTheme: true })(Scheduler);

export default SchedulerWrapped;
